...
namespace Articy.Dracula_1stStepsDemoProject.Templates
{
    ...
    public class DialogueLineTemplate : IArticyBaseObject, IPropertyProvider
    {
        ...
        public Articy.Dracula_1stStepsDemoProject.Features.DialogueFragmentFeature DialogueFragment
        {
            get
            {
        ...
        {
            Articy.Dracula_1stStepsDemoProject.Templates.DialogueLineTemplate newClone = ((Articy.Dracula_1stStepsDemoProject.Templates.DialogueLineTemplate)(aClone));
            if ((DialogueFragment != null))
            {
                newClone.DialogueFragment = ((Articy.Dracula_1stStepsDemoProject.Features.DialogueFragmentFeature)(DialogueFragment.CloneObject(newClone, aFirstClassParent)));
            }
        ...
        {
            Articy.Dracula_1stStepsDemoProject.Templates.DialogueLineTemplate clone = new Articy.Dracula_1stStepsDemoProject.Templates.DialogueLineTemplate();
