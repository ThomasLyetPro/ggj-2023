namespace Articy.Dracula_1stStepsDemoProject
{
	...
	{
		public static string GetDisplayName(this CameraAngle_f aCameraAngle_f)
		{
			return Articy.Unity.ArticyTypeSystem.GetArticyType("CameraAngle_f").GetEnumValue(((int)(aCameraAngle_f))).DisplayName;
		}
